*-----------------------------------------------------------------------------------------------------------------------------------------------
* 	Title	: Competing risk analysis in comparative antimalarial studies
*-------------------------------------------------------------------------------------------------------------
...
* 	event1_A		: Primary event of interest (recrudescence) (1= recrudescence, 0=otherwise) for drug A
...
* 	event1_B		: Primary event of interest (recrudescence) (1= recrudescence, 0=otherwise) for drug B
...
*------------------------------------------------------------------------------------------------------------------------------------------------
*	Related Publication:
* 	This script was used to generate data for "Simulation study II" described in the following publication:
...
survsim stime_drugA_rc event1_A , logcumhazard( -3.709159 :-  (63.62843 :* (log(#t):^(-1):-0.2849155948)) :-0.3799831 :*((log(#t):^(2) ) :- 12.318776))   mintime(14) maxtime(63)
...
// new drug (drug B)
survsim stime_drugB_rc event1_B, logcumhazard( -3.709159 :-  (63.62843 :* (log(#t):^(-1):-0.2849155948)) :-0.3799831 :*((log(#t):^(2) ) :- 12.318776))   mintime(14) maxtime(63)
...
// new drug (drug B)
survsim stime_drugB_rc event1_B , logcumhazard( -2.709159 :-  (63.62843 :* (log(#t):^(-1):-0.2849155948)) :-0.3799831 :*((log(#t):^(2) ) :- 12.318776))   mintime(14) maxtime(63)
survsim stime_drugB_ri event2_B, logcumhazard( -2.892372:+ (9501.215 :* (log(#t):^(-2):-.0858274119)) :- 31651.33 :*((log(#t):^(-2) :* log(log(#t))) :-0.1053710362):+ 29340.83:*((log(#t):^(-2) :* log(log(#t)):^(2)) :-0.1293649082):-12690.51:*((log(#t):^(-2) :* log(log(#t)):^(3)) :-0.1588223868))  mintime(14) maxtime(63)
...
// new drug (drug B)
survsim stime_drugB_rc event1_B , logcumhazard( -4.709159 :-  (63.62843 :* (log(#t):^(-1):-0.2849155948)) :-0.3799831 :*((log(#t):^(2) ) :- 12.318776))   mintime(14) maxtime(63)
survsim stime_drugB_ri event2_B, logcumhazard( -2.892372:+ (9501.215 :* (log(#t):^(-2):-.0858274119)) :- 31651.33 :*((log(#t):^(-2) :* log(log(#t))) :-0.1053710362):+ 29340.83:*((log(#t):^(-2) :* log(log(#t)):^(2)) :-0.1293649082):-12690.51:*((log(#t):^(-2) :* log(log(#t)):^(3)) :-0.1588223868))  mintime(14) maxtime(63)
